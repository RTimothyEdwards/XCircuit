...
GS_LIBS = 
HAVE_LGF = LGF
INC_SPECS =  -I/usr/include/tcl8.6 -I/usr/include/tcl8.6
...
LDFLAGS =  
LD_RUN_PATH = -Wl,-rpath,/usr/lib/x86_64
LIBOBJS = 
LIBS = -ldl -lz  -lpthread -lm -lz -lXt  -lSM -lICE -lm  -lX11 -lXpm $(cairo_LIBS) $(fontconfig_LIBS) ${GS_LIBS}
LIB_SPECS =  -L/usr/lib/x86_64-linux-gnu -ltcl8.6 -L/usr/lib/x86_64-linux-gnu -ltk8.6
LTLIBOBJS = 
M4 = /bin/m4
MAKEINFO = makeinfo
MKDIR_P = /bin/mkdir -p
